...
export const Cards = ({ selectId }) => {
  ...
  const cards = useMemo(() => {
    const allCards = [
      ...
      { id: 'components', condition: (selectId === 'all' || selectId === 'components'), title: t('СертификатЕАЭС'), docType: '2-3' },
      { id: 'components', condition: (selectId === 'all' || selectId === 'components'), title: t('ДекларацияТр'), docType: '2-4' },
      { id: 'components', condition: (selectId === 'all' || selectId === 'components'), title: t('СертификатНаТип'), docType: '2-5' },
      { id: 'components', condition: (selectId === 'all' || selectId === 'components'), title: t('СертификатТр'), docType: '2-6' },
      { id: 'components', condition: (selectId === 'all' || selectId === 'components'), title: t('Гидропривод'), docType: '2-7' },
      { id: 'components', condition: (selectId === 'all' || selectId === 'components'), title: t('05918'), docType: '2-8' },
      { id: 'components', condition: (selectId === 'all' || selectId === 'components'), title: t('Декларация032'), docType: '2-9' },
      { id: 'components', condition: (selectId === 'all' || selectId === 'components'), title: t('Декларация010'), docType: '2-10' },
